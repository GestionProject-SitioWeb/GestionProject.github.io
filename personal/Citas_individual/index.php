...
if (isset($_SESSION["nombre"]) && isset($_SESSION["apellido"])) {
	...
	$sql = "SELECT cm.Id_Maestro, e.nombre AS nombre_estudiante, e.apellido AS apellido_estudiante, 
	        ...
	        cm.motivo, cm.fecha, cm.hora, cm.comentario, p.Id_Personal,e.Id_Estudiante, e.carrera
	        FROM citamaestro cm
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item">
						<a class="nav-link" href="Cita_Maestro.php">Crear Cita</a>
					</li>
					<li class="nav-item">
									...
									<?php while ($fila = $resultado->fetch_assoc()): ?>
										<tr class="text-gray-700 dark:text-gray-400">
											<td class="px-4 py-3 text-sm">
												<?php echo $fila['nombre_estudiante'] . ' ' . $fila['apellido_estudiante']; ?>
											</td>
											...
											<td class="px-4 py-3 text-center">
												<a href="modificarcitas.php?id=<?php echo $fila['Id_Maestro']; ?>" class="btn btn-warning btn-sm me-2">
													<i class="fas fa-edit"></i>
												</a>
												<a href="#" class="btn btn-danger btn-sm" onclick="eliminarCita(<?php echo $fila['Id_Maestro']; ?>)">
